...
public class BluetoothCommService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(SmartLamp.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(SmartLamp.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(SmartLamp.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(SmartLamp.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SmartLamp.TOAST, "Unable to connect to device. Terminating...");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
    	...
    	if (getState() != STATE_EXIT)
    	{
	        ...
	        Message msg = mHandler.obtainMessage(SmartLamp.MESSAGE_TOAST);
	        Bundle bundle = new Bundle();
	        bundle.putString(SmartLamp.TOAST, "Device connection was lost");
	        msg.setData(bundle);
	        mHandler.sendMessage(msg);
    	}
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SmartLamp.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
